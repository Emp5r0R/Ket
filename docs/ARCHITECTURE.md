...
| Android | `VpnService`, map-first Compose UI, shared contracts | Kotlin/Compose, Hysteria2, Xray, hev-socks5-tunnel | Current arm64 physical packet flow, fallback, recovery, cancellation, and disconnect verified; API 26 and release signing pending |
