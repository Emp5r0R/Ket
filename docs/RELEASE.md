...
| Server data planes | Compose transport overlays | Hysteria2 and REALITY live-tested on Oracle ARM64; Shadowsocks TCP traffic/lifecycle locally verified; XHTTP/TLS Stealth, WireGuard TLS, and OpenVPN/stunnel locally validated with deployment gates pending |
