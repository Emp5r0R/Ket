...
| Server data planes | Compose transport overlays | Hysteria2 and REALITY live-tested on Oracle ARM64; XHTTP/TLS and Shadowsocks TCP traffic/lifecycle locally verified; WireGuard TLS and OpenVPN/stunnel locally validated with deployment gates pending |
